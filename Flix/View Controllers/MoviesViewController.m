...
@property (strong, nonatomic) NSMutableArray *changedFilteredMovies;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.descriptionView.text = movie[@"overview"];
    ...
    [cell.coverView setImageWithURL:posterURL];
